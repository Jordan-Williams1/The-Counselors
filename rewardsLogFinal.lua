...
function scene:show( event )
    ...
    if ( phase == "will" ) then
       ...
       local pickText = display.newText("          Jeff:\n Behavior Problems", display.contentWidth/2, display.contentHeight-display.contentHeight + 100, native.systemFont, 50)
        ...
        local childTEXT = display.newText("LOG OF Rewards GOES HERE", display.contentWidth/2+140, display.contentHeight/2, 400, 200)
        childTEXT.size = 40
