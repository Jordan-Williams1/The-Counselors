...
{
$newChild = "INSERT INTO child (username,password,name,age,grade,ExtrovertIntrovert,OutgoingShy,LeaderFollower,ActiveCalm,PlannerImpulsive,CaringUncaring,Strengths,Weaknesses,MaturityLevel,Interests,DisciplineWorked,DisciplineNotWorked) values('$username','$password','$child1[0]','$child1[1]','$child1[2]','$child1[3]','$child1[4]','$child1[5]','$child1[6]','$child1[7]','$child1[8]','$child2[0]','$child2[1]','$child2[2]','$child2[3]','$child2[4]','$child2[5]');";
